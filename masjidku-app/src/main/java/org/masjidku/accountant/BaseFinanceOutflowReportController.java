...
/**
 * Base Finance Outflow Report Controller to eliminate code duplication across payment/recipient report controllers.
 */
public abstract class BaseFinanceOutflowReportController<T> extends BaseTableController<T> {
    @FXML
